...
#include "AtlasStyle.C"
  ...
  TH1F *DrawRatioPlot(TString TitleY, TH1F* hist1, TH1F* hist2, float setRangeA_Y = 0.29, float setRangeB_Y = 1.31, float setRangeA_X = 0., float setRangeB_X = 0.){
      ...
      int nBins = 0;
      nBins = h_ratio->GetNbinsX(); /// method GetNBinsX() provides get  number of bins in hostogram
  ...
  TH1F *DrawTwoHist(TString name, TString band1, TString band2, TH1F *hist1, TH1F *hist2, TString TitleX, TString TitleY, bool DrawPlot = false, bool SetNormalization = false, TString TitleY_sub = "ratio"){
     ...
     /// set parameters of the histograms (color, width ...)
      ...
      TLegend *leg1 = new TLegend(0.7042607,0.7478261,0.839599,0.9330435);
      ...
      leg1->AddEntry(hist1, Form("%s", band1.Data()),"lp");
